...
bottom <- read.csv('/Users/emiliasicari/Desktop/Third_assignment/ObservationData_zqpldgb.csv', header = TRUE, skip = 20)
#erasing columns
...
top <-read.csv('/Users/emiliasicari/Desktop/Third_assignment/ObservationData_rblkfmd.csv', header = TRUE, skip = 20)
#erasing columns
top$Singapore <- NULL
...
#creating the final, complete dataframe and cleaning it
complete.dataframe <- merge (dataframe5, car.pop1.other, by ='date')
complete.dataframe$type <- NULL
names(complete.dataframe) <- c("date", "gdp.per.capita", "inequality", "cars", "rentalcars", "taxis", "buses", "motorbikes", "other")
...
After importing data on R and cleaning them, we merged the datasets. The final dataset has twenty observations, and eight variable, observed throughout the years 1995 - 2014. 
