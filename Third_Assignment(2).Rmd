...
fig.1 <- ggplot(data.final, aes(x= date)) +
...
![Figure 5 - Correlation plot](/Users/emiliasicari/Desktop/Third_assignment/Figures/Correlation plot.png)
...
stargazer::stargazer(m1,
    title = "Multiple regeression model", covariate.labels = "labels1", 
    digits = 2, type = 'latex', header =  FALSE)
```

## Further steps
- investigating collinearity (VIF analysis)
- 
# References
