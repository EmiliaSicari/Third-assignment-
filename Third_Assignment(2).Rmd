...
stargazer(data.final.s, type = "latex",
        ...
        digits = 1, out = "General data summary.text.output", header = FALSE)
```
...
in Singapore measured in national currency at current prices (1995-2014)") +
  theme(plot.title = element_text(lineheight=0.5, size = 10))
fig.1
```
...
![Figure 5:Correlationplot](/Users/rafalopezv/Dropbox/R/Third-assignment/Figures/Correlation Plot.png)
