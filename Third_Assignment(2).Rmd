...
#making the axes appear
fig.1 <- fig.1 + theme(axis.line= element_line(size = 0.25, linetype = "solid",
                                                  colour = "black"))
...
fig.4 <- fig.4 + theme(panel.border = element_blank(),
                       ...
                       panel.grid.minor = element_blank())
#making the axes appear
fig.4 <- fig.4 + theme(axis.line= element_line(size = 0.25, linetype = "solid",
                                                  colour = "black"))
...
![Figure 5:Correlationplot](/Users/rafalopezv/Dropbox/R/Third-assignment/Correlation Plot.png)
